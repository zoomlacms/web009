        ...
        <div class="left_user">
					...
					<div class="commonuser" runat="server" id="leftChk5">
						...
						<div class="content history_c">
                            <a href="javascript:;" class="btn btn-xs btn-info" onclick="ShowMain('','/Office/Office/Default.aspx');">发文管理</a> 
                            <a href="javascript:;" class="btn btn-xs btn-info" onclick="ShowMain('','/Office/AffairsList.aspx?view=1');">待办事务</a> 
                            <a href="javascript:;" class="btn btn-xs btn-info" onclick="ShowMain('','/Office/Mail/MessageSend.aspx');">写邮件</a> 
                            <a href="javascript:;" class="btn btn-xs btn-info" onclick="ShowMain('','/Office/Mail/Message.aspx');">收邮件</a> 
                            <a href="javascript:;" class="btn btn-xs btn-info" onclick="ShowMain('','/Mis/MisAttendance');">签到</a> 
							<div class="clearfix"></div>
						</div>
					</div> 
        </ul>
