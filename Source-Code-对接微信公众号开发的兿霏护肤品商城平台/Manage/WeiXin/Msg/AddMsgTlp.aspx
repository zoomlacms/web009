     ...
     <%--               <div>多图文支持html</div>--%>
        ...
        <tbody class="content_tb" id="image_tb">
            ...
            <tr>
                <td>图片</td>
                <td>
                    <asp:TextBox runat="server" ID="Image_PicUrl_T" CssClass="form-control m715-50" placeholder="http://demo.z01.com/pic.jpg" />
        ...
        <tr>
            ...
            <td>
                ...
                <a href="MsgList.aspx" class="btn btn-info">返回列表</a>
            </td>
        </tr>
    </table>
</asp:Content>
