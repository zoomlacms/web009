...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <textarea style="width: 500px; height: 120px;" id="FlowPrcess" runat="server" class="form-control" cols="6"></textarea>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input id="txtPCode" class="form-control text_300" runat="server" /><label style="color: Red">*<asp:RequiredFieldValidator
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPassCode" class="form-control text_300" runat="server"></asp:TextBox><label style="color: Red">*</label>
        ...
        <tr>
            ...
            <td class="style3">
                <asp:TextBox ID="txtNoPassCode" class="form-control" runat="server" CssClass="form-control text_300"></asp:TextBox><label style="color: Red">*</label>
