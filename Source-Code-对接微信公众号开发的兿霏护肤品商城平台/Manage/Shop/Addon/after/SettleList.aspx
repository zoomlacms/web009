...
<asp:Content runat="server" ContentPlaceHolderID="head"><title>结清管理</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
 <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
        <li><a href='<%=CustomerPageAction.customPath2 %>Main.aspx'>工作台</a></li>
        <li><a href='../../OrderMangae.aspx'>订单管理</a></li>
        <li class="active">结清管理</li>
...
<ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false" 
    ...
    <Columns>
        ...
        <asp:BoundField HeaderText="结清金额" DataField="AmountSettle" DataFormatString="{0:F2}" ItemStyle-CssClass="td_m" />
