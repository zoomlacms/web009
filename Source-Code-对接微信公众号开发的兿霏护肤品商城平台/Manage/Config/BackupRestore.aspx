        ...
        <table id="tab0" class="table table-striped table-bordered table-hover tabs">
            ...
            <tr class="tdbg">
                ...
                <td>
                    ...
                    <span id="backup_sp" runat="server" style="float: left; margin-top: 0.3em;"> <asp:CheckBox ID="chBackup" runat="server"  Style="margin-left: 5px;"/><label for="chBackup" style="font-weight:normal">备份在根目录(默认为temp目录)。</label> </span>
                </td>
            </tr>
            <tr class="tdbg">
