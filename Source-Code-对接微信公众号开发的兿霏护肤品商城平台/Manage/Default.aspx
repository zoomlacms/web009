    ...
    <div class="m_top">
                ...
                <li class="menu3_13">
                    <div class="btn-group topdrop">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="javascript:;" data-url="Content/ModelManage.aspx?ModelType=5">商品模型</a></li>
     ...
     <%--           <li class="menu7_7"><a onclick="showleft('menu7_7','File/Addlinkhttp.aspx')"><%=Resources.L.站内链接 %></a></li>--%>
            ...
            <ul class="menu10">
                ...
                <li class="menu10_6"><a onclick="showleft('menu10_5','TouTiao/TouTiaoContent.aspx');">头条管理</a></li>
            ...
            <div id="left_ul_div">
                ...
                <div id="menu3" class="m_left_ul">
                    ...
                    <ul id="menu3_3" class="m_left_ulin">
                        ...
                        <li id="menu3_3_16"><a href="javascript:;" data-url="UserShopManage/DeliveryMan.aspx">送货员管理</a></li>
                    </ul>
            ...
            <ul class="list-unstyled">
                ...
                <!--<li id="menu3_8_11"><a href="javascript:;" data-url="Shop/profile/LmUserManage.aspx">联盟会员</a></li>-->
                    ...
                    <ul id="menu3_13" class="m_left_ulin">
                        ...
                        <li id="menu3_13_6"><a href="javascript:;" data-url="UserShopManage/ShopinfoManage.aspx">店铺配置</a></li>
		...
		<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
                ...
                <div id="menu10" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu10_5">
                        ...
                        <li id="menu10_5_2"><a href="javascript:;" data-url="TouTiao/AddTouTiaoVideo.aspx">发布视频</a></li>
                    </ul>
