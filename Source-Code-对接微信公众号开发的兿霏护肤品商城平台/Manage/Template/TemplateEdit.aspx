<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateEdit.aspx.cs" Inherits="ZoomLaCMS.Manage.Template.TemplateEdit"  MasterPageFile="~/Manage/I/Default.master"  ValidateRequest="false"%>
...
<table class="table table-striped table-bordered" align="center">
	<tr class="title" style="font-weight: normal;">
		<td align="left" colspan="2">
			<div class="input-group" runat="server" style="width:400px;">             
			  <span class="btn btn-default input-group-addon"><i class="fa fa-edit"></i></span>
				<span class="input-group-addon">
					<asp:Label ID="FolderName_L" runat="server" />
				</span>
                    <asp:TextBox ID="FileName_T" runat="server" CssClass="form-control"></asp:TextBox>
                    <span class="input-group-addon"><asp:Label runat="server" ID="FileExt_L" /></span>
                </div>
        ...
        <div class="col-lg-8 col-md-8" style="border:1px solid #ddd;padding:0;">
        ...
        <tr>
            <td colspan="2" style="padding-left:450px;">
              <asp:LinkButton ID="SaveTem_LB" runat="server" OnClick="btnSave_Click" CssClass="btn btn-primary"><i class="fa fa-file-text"></i> 保存模板</asp:LinkButton>
