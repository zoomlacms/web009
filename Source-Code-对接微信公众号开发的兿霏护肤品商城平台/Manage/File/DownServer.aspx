...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr >
            ...
            <td  style="text-align: left; width: 60%;">
                <asp:DropDownList ID="Encrypttype" CssClass="form-control" runat="server">
        ...
        <tr  id="Tr2" runat="server">
            <td align="left">
                ...
                单位：分钟, 0 为不更新</td>
            <td  style="text-align: left; width: 60%;">
                <asp:TextBox ID="UpTimeuti" CssClass="form-control text_300" runat="server">0</asp:TextBox>
                <asp:DropDownList ID="UpTimeutiList" CssClass="form-control text_300" runat="server">
        ...
        <tr >
            ...
            <td  style="text-align: left; width: 60%;">
                <asp:DropDownList ID="DropShowType" CssClass="form-control text_300" runat="server">
