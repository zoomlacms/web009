<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Camera.aspx.cs" Inherits="ZoomLaCMS.Plugins.Camera" MasterPageFile="~/Common/Common.master" EnableViewStateMac="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul id="RightPreView" class="leftphoto">
                                <li class='curr' id="need" style="display: none;">
                                    <img width='128' height='96' src="#" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    function shoot() {
        ...
        if (imgNum > 7) { alert("最多只能同时上传八张照片"); return; }
        imgNum++;
